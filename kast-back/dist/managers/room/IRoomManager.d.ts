...
export default abstract class IRoomManager {
    abstract createRoom(userId: string, name: string, type: RoomType, passwordProtected: boolean, password: string | undefined): Promise<Room>;
    abstract joinRoom(userId: string, inviteLink: string, password: string | undefined): Promise<Room>;
    ...
    abstract getParticipantsTracks(userId: string, roomId: string): Promise<ParticipantMedia[]>;
    abstract getInviteLink(roomId: string): Promise<string>;
    abstract raiseHand(roomId: string, userId: string, raiseHand: boolean): Promise<boolean>;
    ...
    abstract mute(action: MuteAction, source: MuteSource, userId: string, owner: string, roomId: string, producerId: string): Promise<boolean>;
    abstract muteAll(action: MuteAction, userId: string, owner: string, roomId: string): Promise<boolean>;
