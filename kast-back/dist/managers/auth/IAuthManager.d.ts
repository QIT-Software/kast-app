...
export default abstract class IAuthManager {
    abstract register(appType: AppType, platform: Platform, email: string, password: string, name: string, referralCode: string): Promise<AuthResponse>;
    abstract login(appType: AppType, platform: Platform, email: string, password: string): Promise<AuthResponse>;
    ...
    abstract changePassword(userId: ID, oldPassword: string, password: string): Promise<void>;
